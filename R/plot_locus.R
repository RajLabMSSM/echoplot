...
#'  Examples:
#'  \itemize{
#'  \item \code{"ENCODE_TFBS_ClusteredV3_CellTypes"}
#'  \item \code{"ENCODE_DNaseI_ClusteredV3_CellTypes"}
#'  \item \code{"Broad_Histone"}
#'  }
...
#' @param height height (defaults to the height of current
#'   plotting window)
#' @param width width (defaults to the width of current
#'   plotting window)
