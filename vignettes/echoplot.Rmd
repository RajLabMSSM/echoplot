...
```{r trk_plot.xgr, attr.output='style="max-height: 200px;"', eval=FALSE}
...
```{r trk_plot.roadmap, attr.output='style="max-height: 200px;"', eval=FALSE} 
...
```{r trk_plot.nott_2019, attr.output='style="max-height: 200px;"', eval=FALSE} 
...
```{r trk_plot.QTL, attr.output='style="max-height: 200px;"', eval=FALSE}
